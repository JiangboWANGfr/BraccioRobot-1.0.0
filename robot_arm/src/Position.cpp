...
int Position::limit(int value, int minv, int maxv)
{
    int result;
    if (value < minv)
    {
...
int Position::maxPositionDiff(const Position &p) const
{
    int maxDiff = 0;
...
int Position::setFromString(char *string)
{
    bool isSuccess = true;
    int speed;
...
int Position::parseInt(char *&in, bool &isSuccess)
{
    bool success = false;
    int result = 0;
